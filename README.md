...
It helps you match the components or parents if it's given no arguments.
1. How would you explain form validation to someone who has never programmed before?
It's a process that checks if the information given to the user is accurate. 
1. In 1-2 sentences, define end to end testing.
It's a testing method that tests a program from end to end. 
